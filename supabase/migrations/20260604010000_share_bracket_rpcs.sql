-- R15: promote the share-bracket RPCs (create_share_token / get_shared_bracket)
-- from supabase/sql/ into migrations so they actually get applied to prod.
-- Previously these 404'd in prod (PGRST202) and share degraded to base64 URLs.
